...
Allow authenticated users to comment on tasks, reply one level deep to root comments, list comments with author and reply previews, delete their own comments, and dispatch domain events on comment and reply creation for a later broadcasting stage.
