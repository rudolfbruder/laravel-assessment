...
Provide server-side search and status filtering for the authenticated user's tasks on the task index endpoint, with filtering performed through a configuration-selectable repository contract.
